...
*/window.addEventListener("load",function(){xn()},!1);const wn={startOnLoad:!0,htmlLabels:!0,mermaidAPI:_n,parse:_n.parse,render:_n.render,init:function(){const t=_n.getConfig();let e,n,r;b.debug("Starting rendering diagrams"),arguments.length>=2?(/*!sequence config was passed as #1*/void 0!==arguments[0]&&(wn.sequenceConfig=arguments[0]),e=arguments[1]):e=arguments[0],"function"==typeof arguments[arguments.length-1]?(n=arguments[arguments.length-1],b.debug("Callback function found")):void 0!==t.mermaid&&("function"==typeof t.mermaid.callback?(n=t.mermaid.callback,b.debug("Callback function found")):b.debug("No Callback function found")),e=void 0===e?document.querySelectorAll(".mermaid"):"string"==typeof e?document.querySelectorAll(e):e instanceof window.Node?[e]:e,b.debug("Start On Load before: "+wn.startOnLoad),void 0!==wn.startOnLoad&&(b.debug("Start On Load inner: "+wn.startOnLoad),_n.initialize({startOnLoad:wn.startOnLoad})),void 0!==wn.ganttConfig&&_n.initialize({gantt:wn.ganttConfig});for(let t=0;t<e.length;t++){const a=e[t];/*!Check if previously processed*/if(a.getAttribute("data-processed"))continue;a.setAttribute("data-processed",!0);const o=`mermaid-${Date.now()}`;r=a.innerHTML,r=i.a.decode(r).trim().replace(/<br>/gi,"<br/>"),_n.render(o,r,(t,e)=>{a.innerHTML=t,void 0!==n&&n(o),e(a)},a)}},initialize:function(t){b.debug("Initializing mermaid "),void 0!==t.mermaid&&(void 0!==t.mermaid.startOnLoad&&(wn.startOnLoad=t.mermaid.startOnLoad),void 0!==t.mermaid.htmlLabels&&(wn.htmlLabels=t.mermaid.htmlLabels)),_n.initialize(t)},contentLoaded:xn};e.default=wn}]).default});